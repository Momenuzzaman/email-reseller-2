...
const PricingCard = () => {
  return (
    <section className="px-3 lg:px-0">
      <div className="max-w-7xl mx-auto  bg-gray-900 rounded-lg mt-[120px]">
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          ...
          <div className="space-y-8 lg:grid lg:grid-cols-3 lg:space-y-0">
            <div className="flex flex-col p-6 w-5/6 mx-auto text-center rounded-lg border border-gray-600 shadow xl:p-8 bg-gray-800 text-white">
              ...
              <div className="border-b-2 border-gray-600  mb-[26px] font-Montserrat">
              ...
              <ul role="list" className="mb-8 space-y-4 font-Montserrat">
                <li className="flex items-center space-x-3  text-center">
                  ...
                  <span className="font-semibold">10 GB Disk Space</span>
                </li>
                <li className="flex items-center space-x-3">
                  ...
                  <span className="font-semibold">1 Year Support</span>
                </li>
                <li className="flex items-center space-x-3">
                  <svg
                    className="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400"
                  ...
                  <span className="font-semibold">500 Queries</span>
                </li>
                <li className="flex items-center space-x-3">
                  <svg
                    className="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400"
            ...
            <div className="flex flex-col p-6 mx-auto w-5/6  text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 ">
              ...
              <button className="font-Montserrat btn btn-outline bg-[#FF4800] text-white hover:text-[#FF4800] hover:border-[#FF4800] py-[14px] px-[32px]">
                Get Started
              </button>
            </div>
            {/* 3rd */}
